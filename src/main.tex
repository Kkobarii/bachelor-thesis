\documentclass[czech,bachelor]{resources/diploma/diploma}
...
\ThesisAuthor{barca je moc chytra}
...
\newcommand{\includeplantuml}[2][]{%
    \IfFileExists{figures/diagrams/activity/out/#2.pdf}{%
        \immediate\write18{if [ figures/diagrams/activity/#2.puml -nt figures/diagrams/activity/out/#2.pdf ]; then java -jar resources/libs/plantuml-1.2024.3.jar -o out -tsvg figures/diagrams/activity/#2.puml; inkscape figures/diagrams/activity/out/#2.svg --export-area-drawing --export-filename=figures/diagrams/activity/out/#2.pdf; rm figures/diagrams/activity/out/#2.svg; fi}
    }{%
        \immediate\write18{java -jar resources/libs/plantuml-1.2024.3.jar -o out -tsvg figures/diagrams/activity/#2.puml; inkscape figures/diagrams/activity/out/#2.svg --export-area-drawing --export-filename=figures/diagrams/activity/out/#2.pdf; rm figures/diagrams/activity/out/#2.svg}
    }
    \includegraphics[#1]{figures/diagrams/activity/out/#2.pdf}
}
