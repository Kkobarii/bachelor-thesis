...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.9]{figures/diagrams/schema/er_macro.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics{figures/diagrams/schema/er_action.pdf}
    \caption{Schéma akcí}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/diagrams/schema/er_character.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics{figures/diagrams/schema/er_location.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics{figures/diagrams/schema/er_enemy_obstacle.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.8]{figures/diagrams/schema/er_adventure.pdf}
