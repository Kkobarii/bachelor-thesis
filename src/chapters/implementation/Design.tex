...
Podle požadavků stanovených v~předchozí kapitole \chapterref{chap:requirements} byl vytvořen návrh herního systému, který je pro přehlednost rozdělen do několika částí. První část se zabývá návrhem herních modelů, druhá se zaměřuje na herní mechaniky a~třetí popisuje návrh herních komponent.
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.8]{figures/diagrams/schema/er_macro.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.8]{figures/diagrams/schema/er_action.pdf}
    \caption{Schéma akcí}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.8]{figures/diagrams/schema/er_character.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.8]{figures/diagrams/schema/er_location.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.8]{figures/diagrams/schema/er_enemy_obstacle.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.8]{figures/diagrams/schema/er_campaign.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/diagrams/schema/er_effect.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.98\textheight]{figures/diagrams/activity/encounter.pdf}
...
\textbf{Uvolnění efektu} je oproti dvěma předchozím krokům jednoduché, jedná se o~pouhé snížení počítadla kol a~případné odstranění efektu z~listu efektů dané entity, pokud jeho trvání vypršelo.
